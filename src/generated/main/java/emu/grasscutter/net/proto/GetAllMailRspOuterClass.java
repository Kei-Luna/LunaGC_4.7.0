...
public final class GetAllMailRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int IS_TRUNCATED_FIELD_NUMBER = 4;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (isTruncated_ != false) {
        output.writeBool(4, isTruncated_);
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (isTruncated_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(4, isTruncated_);
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\rGetAllMailRsp\022\024\n\014is_truncated\030\004 \001(\010\022\017\n\007" +
      "retcode\030\007 \001(\005\022\034\n\tmail_list\030\010 \003(\0132\t.MailD" +
    ...
    internal_static_GetAllMailRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GetAllMailRsp_descriptor,
        new java.lang.String[] { "IsTruncated", "Retcode", "MailList", "IsCollected", });
    emu.grasscutter.net.proto.MailDataOuterClass.getDescriptor();
  }
